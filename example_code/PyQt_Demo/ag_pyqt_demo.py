...
class GetFrequency(QtCore.QObject):
    ...
    def runWork(self):
        while True:
            get_data, recv_data_buf = scpi_query(1, ':FUNCtion:FREQuency?\r\n')
            if get_data:
...
class MainWindow(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.frequency.setText("CH1 Frequency: ")

        self.button1 = QPushButton("1KHz")
        self.button1.clicked.connect(self.button1_ops)
        self.button2 = QPushButton("10KHz")
        ...
        mainLayout.addWidget(self.frequency)
    ...
    def button1_ops(self):
        get_data, recv_data_buf = scpi_query(1, ':FUNCtion:FREQuency 1000\r\n')

    def button2_ops(self):
        get_data, recv_data_buf = scpi_query(1, ':FUNCtion:FREQuency 10000\r\n')

    def updateValue(self, freq):
        self.frequency.setText("CH1 Frequency: " + freq + " Hz")
...
if __name__ == '__main__':
    ...
    mainWindow.setWindowTitle("AG Python Demo")
